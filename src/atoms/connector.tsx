...
export class Connector extends React.Component<any, any>{
    constructor(props) {
        super(props);
        this.state = {
            dragPoint: {}
    ...
    render() {
        ...
        const {xp, yp} = this.state.dragPoint;
        const instructions = `
        M ${x}, ${y}
        C ${x + 50},${y} ${xp - 50},${yp} ${xp},${yp}
        `
        ...
        return (
            <div>
                ...
                <div className="connector-left" onMouseDown={this.handleMouseClick}></div>
            </div>
        );
    }

    handleMouseDrag = e => {
        this.setState({dragPoint: {xp: e.pageX, yp: e.pageY}})
    }
